...
public class CatalogTest {
    ...
    private static void testingMatcher(String s, String art, String exp) {
        System.out.println("Testing with article: " + art);
        String ans = Catalog.catalogMatcher(s, art);
        System.out.println("Actual: " + ans);
        System.out.println("Expect: " + exp);
        assertEquals(exp, ans);
    }
    ...
    public void testMatcher() {
        testingMatcher(s, "ladder" , "ladder > prx: $112 qty: 12");
        testingMatcher(s, "saw" , "table saw > prx: $1099.99 qty: 5\nsaw > prx: $9 qty: 10\nsaw for metal > prx: $13.80 qty: 32");
        testingMatcher(s, "wood pallet" , "wood pallet > prx: $65 qty: 21");
